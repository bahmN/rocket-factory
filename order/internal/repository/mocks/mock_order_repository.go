...
func (_m *OrderRepository) Create(ctx context.Context, order model.OrderInfo) error {
...
func (_c *OrderRepository_Create_Call) Run(run func(ctx context.Context, order model.OrderInfo)) *OrderRepository_Create_Call {
...
func (_c *OrderRepository_Create_Call) RunAndReturn(run func(context.Context, model.OrderInfo) error) *OrderRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}

// Get provides a mock function with given fields: ctx, uuid
func (_m *OrderRepository) Get(ctx context.Context, uuid string) (model.OrderInfo, error) {
...
func (_c *OrderRepository_Get_Call) Return(_a0 model.OrderInfo, _a1 error) *OrderRepository_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *OrderRepository_Get_Call) RunAndReturn(run func(context.Context, string) (model.OrderInfo, error)) *OrderRepository_Get_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function with given fields: ctx, uuid, order
func (_m *OrderRepository) Update(ctx context.Context, uuid string, order model.OrderInfo) error {
...
func (_c *OrderRepository_Update_Call) Run(run func(ctx context.Context, uuid string, order model.OrderInfo)) *OrderRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string), args[2].(model.OrderInfo))
	})
	return _c
}
...
func (_c *OrderRepository_Update_Call) RunAndReturn(run func(context.Context, string, model.OrderInfo) error) *OrderRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
