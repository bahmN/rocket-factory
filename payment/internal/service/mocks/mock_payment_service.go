...
import (
	...
	model "github.com/bahmN/rocket-factory/payment/internal/model"
...
func (_m *PaymentService) PayOrder(ctx context.Context, info model.PaymentInfo) (string, error) {
...
func (_c *PaymentService_PayOrder_Call) Run(run func(ctx context.Context, info model.PaymentInfo)) *PaymentService_PayOrder_Call {
...
func (_c *PaymentService_PayOrder_Call) RunAndReturn(run func(context.Context, model.PaymentInfo) (string, error)) *PaymentService_PayOrder_Call {
	_c.Call.Return(run)
	return _c
}
