...
import (
	v1 "github.com/bahmN/rocket-factory/shared/pkg/proto/common/v1"
...
func (x *WhoaimRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WhoaimRequest) ProtoMessage() {}

func (x *WhoaimRequest) ProtoReflect() protoreflect.Message {
	mi := &file_auth_v1_auth_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WhoaimRequest.ProtoReflect.Descriptor instead.
func (*WhoaimRequest) Descriptor() ([]byte, []int) {
	return file_auth_v1_auth_proto_rawDescGZIP(), []int{2}
}

func (x *WhoaimRequest) GetSessionUuid() string {
	if x != nil {
		return x.SessionUuid
	}
	return ""
...
func (x *WhoaimResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WhoaimResponse) ProtoMessage() {}

func (x *WhoaimResponse) ProtoReflect() protoreflect.Message {
	mi := &file_auth_v1_auth_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WhoaimResponse.ProtoReflect.Descriptor instead.
func (*WhoaimResponse) Descriptor() ([]byte, []int) {
	return file_auth_v1_auth_proto_rawDescGZIP(), []int{3}
}

func (x *WhoaimResponse) GetSession() *v1.Session {
	if x != nil {
		return x.Session
	}
	return nil
...
func (x *WhoaimResponse) GetUser() *v1.User {
	if x != nil {
		return x.User
	}
	return nil
...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\x06Whoaim\x12\x16.auth.v1.WhoaimRequest\x1a\x17.auth.v1.WhoaimResponseBAZ?github.com/bahmN/rocket-factory/shared/pkg/proto/auth/v1;authV1b\x06proto3"
...
var file_auth_v1_auth_proto_goTypes = []any{
	...
	(*WhoaimRequest)(nil),  // 2: auth.v1.WhoaimRequest
	(*WhoaimResponse)(nil), // 3: auth.v1.WhoaimResponse
	(*v1.Session)(nil),     // 4: common.v1.Session
	(*v1.User)(nil),        // 5: common.v1.User
}
var file_auth_v1_auth_proto_depIdxs = []int32{
	4, // 0: auth.v1.WhoaimResponse.session:type_name -> common.v1.Session
	5, // 1: auth.v1.WhoaimResponse.user:type_name -> common.v1.User
	0, // 2: auth.v1.AuthService.Login:input_type -> auth.v1.LoginRequest
	2, // 3: auth.v1.AuthService.Whoaim:input_type -> auth.v1.WhoaimRequest
	1, // 4: auth.v1.AuthService.Login:output_type -> auth.v1.LoginResponse
	3, // 5: auth.v1.AuthService.Whoaim:output_type -> auth.v1.WhoaimResponse
