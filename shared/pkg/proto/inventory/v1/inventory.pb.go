...
type Manufacturer struct {
	...
	Cuntry        string                 `protobuf:"bytes,2,opt,name=cuntry,proto3" json:"cuntry,omitempty"`
...
func (x *Manufacturer) GetCuntry() string {
	if x != nil {
		return x.Cuntry
	}
	return ""
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	"\n" +
	"\x1cinventory/v1/inventory.proto\x12\finventory.v1\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"$\n" +
	...
	"\x05parts\x18\x01 \x03(\v2\x12.inventory.v1.PartR\x05parts\"\xd8\x04\n" +
	"\x04Part\x12\x12\n" +
	...
	"\x06cuntry\x18\x02 \x01(\tR\x06cuntry\x12\x18\n" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBKZIgithub.com/bahmN/rocket-factory/shared/pkg/proto/inventory/v1;inventoryV1b\x06proto3"
...
var (
	...
	file_inventory_v1_inventory_proto_msgTypes  = make([]protoimpl.MessageInfo, 9)
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	9,  // 6: inventory.v1.Part.metadata:type_name -> inventory.v1.Part.MetadataEntry
	10, // 7: inventory.v1.Part.created_at:type_name -> google.protobuf.Timestamp
	10, // 8: inventory.v1.Part.updated_at:type_name -> google.protobuf.Timestamp
